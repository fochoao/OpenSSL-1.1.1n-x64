...
our %config = (
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\50-masm.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
...
our %target = (
  ...
  MT => "mt",
  MTFLAGS => "-nologo",
  RANLIB => "CODE(0x2629b90)",
  RC => "rc",
  _conf_fname_int => [ "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\10-main.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\00-base-templates.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\50-masm.conf", "C:\\cpython\\externals\\openssl-1.1.1m\\Configurations\\shared-info.pl" ],
